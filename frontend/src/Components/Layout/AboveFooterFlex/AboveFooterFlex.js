...
function AboveFooterFlex() {
  return (
    <div>
      <div className="container--mod mx-auto my-28 md:my-24 lg:my-12 xl:my-32 flex flex-col lg:flex-row-reverse justify-center lg:justify-between items-center text-center lg:text-left gap-10">
